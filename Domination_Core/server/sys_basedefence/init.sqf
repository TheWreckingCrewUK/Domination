...
[_rocket, 1] execVM "domination_core\server\sys_basedefence\IDF_cram.sqf";[_holder,_range] execvm "domination_core\server\sys_basedefence\IDF_marker.sqf"; sleep 3;if (idfon == 0) then { 
