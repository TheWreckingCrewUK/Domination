...
_blacklist = ["ACE_ATragMX", "ACE_Kestrel4500", "TWC_Item_Medical_SutureKit_20", "ACE_microDAGR", "ACE_DAGR", "CUP_V_B_Eagle_SPC_Corpsman", "CUP_V_B_Eagle_SPC_Rifleman", "CUP_V_B_Eagle_SPC_TL", "bipod_01_F_blk", "CUP_acc_ANPEQ_15_Flashlight_Black_L	", "CUP_acc_ANPEQ_15_Black", "UK3CB_BAF_Kite", "CUP_optic_AN_PAS_13c1", "UK3CB_BAF_MaxiKite", "CUP_optic_AN_PVS_10", "UK3CB_BAF_TA648_308", "CUP_optic_GOSHAWK_RIS", "cup_optic_an_pvs_10", "uk3cb_baf_llm_ir_tan", "itemCTAB", "CUP_optic_CWS", "H_PilotHelmetFighter_B"];
