...
systemchat "Starting Deployment in Domination mode, no additional objectives will be added";
...
if ((count _groups) > 2) exitwith {if (twc_campaignmode == 0) then {
	...
	//execvm "domination_core\server\sys_objectives\operation\operation_start.sqf";
};};
