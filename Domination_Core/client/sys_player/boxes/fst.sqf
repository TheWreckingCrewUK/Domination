...
*/
	...
	[_x,0,["ACE_MainActions", "ammospawn", "ammospawnheavy", "spawnm6"],_fstaction5,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions", "ammospawn", "ammospawnheavy"],_fstaction3,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions", "ammospawn", "ammospawnlight"],_snaction1,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions", "ammospawn", "ammospawnheavy"],_fstaction4,true] call ace_interact_menu_fnc_addActionToClass;
