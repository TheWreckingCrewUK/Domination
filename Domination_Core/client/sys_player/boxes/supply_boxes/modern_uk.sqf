...
if((typeOf player) in ["Modern_UKSF_Squadleader","Modern_UKSF_2IC"])then{
	...
	_artaction3 = ["SpawnrepCreate","Spawn MRZR","",{execvm "domination_core\client\sys_player\vehicles\sfmrzr.sqf"},{true}] call ace_interact_menu_fnc_createAction;
	["Land_InfoStand_V1_F",0,["ACE_MainActions"],_artaction3,true] call ace_interact_menu_fnc_addActionToClass;
	
	
	_artaction3 = ["SpawnrepCreate","Spawn MRAP","",{execvm "domination_core\client\sys_player\vehicles\sfmrap.sqf"},{true}] call ace_interact_menu_fnc_createAction;
	["Land_InfoStand_V1_F",0,["ACE_MainActions"],_artaction3,true] call ace_interact_menu_fnc_addActionToClass;
