if((typeOf player) in ["Modern_pol_commander","Modern_pol_commander_d", "Modern_pol_subcommander","Modern_pol_subcommander_d"])then{
	...
	["Land_InfoStand_V1_F",0,["ACE_MainActions"],_UKaction5,true] call ace_interact_menu_fnc_addActionToClass;	
			...
			_artaction3 = ["SpawnrepCreate","Spawn Landmines","",{execvm "domination_core\client\sys_player\boxes\supply_boxes\tm62_mines.sqf"},{(count units group player) >= 4}] call ace_interact_menu_fnc_createAction;
	["Land_InfoStand_V1_F",0,["ACE_MainActions"],_artaction3,true] call ace_interact_menu_fnc_addActionToClass;
	
			_artaction3 = ["SpawnrepCreate","Spawn Marksman Rifle","",{execvm "domination_core\client\sys_player\boxes\supply_boxes\specCratepol_svd.sqf"},{(count units group player) >= 8}] call ace_interact_menu_fnc_createAction;
	["Land_InfoStand_V1_F",0,["ACE_MainActions"],_artaction3,true] call ace_interact_menu_fnc_addActionToClass;
