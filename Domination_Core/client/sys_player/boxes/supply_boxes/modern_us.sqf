if((typeOf player) in ["Modern_USMC_Squadleader","Modern_USMC_Teamleader","Modern_USMC_Squadleader_d","Modern_USMC_Teamleader_d"])then{
	...
	[_x,0,["ACE_MainActions", "ammospawn", "ammospawnlight"],_charlieaction,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions", "ammospawn", "ammospawnsupport"],_charlieaction2,true] call ace_interact_menu_fnc_addActionToClass;
