if((typeOf player) in ["twc_men_1990_us_w_teamleader","twc_men_1990_us_d_teamleader", "twc_men_1990_us_w_SquadLeader","twc_men_1990_us_d_SquadLeader"])then{
	...
	_UKaction = ["SpawnsmallanaCreate","Spawn Small US Crate","",{execvm "domination_core\client\sys_player\boxes\supply_boxes\smallCrateUS90.sqf"},{true}] call ace_interact_menu_fnc_createAction;
