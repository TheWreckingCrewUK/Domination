...
if((typeOf player) in ["twc_pol_commander","twc_pol_subcommander"])then{

	_UKaction = ["SpawnsmallanaCreate","Spawn Small Polish Crate","",{execvm "insurgency_core\client\sys_player\boxes\smallcratepol.sqf"},_condition] call ace_interact_menu_fnc_createAction;
