...
twc_loadout_usarmysniper_shooter = [
	...
	[["all"], ([["CUP_10Rnd_127x99_m107", 50], ["CUP_10Rnd_127x99_m107", 20], ["CUP_10Rnd_127x99_m107", 20], ["CUP_5Rnd_762x51_M24", 50], ["ACE_20Rnd_762x51_M118LR_Mag", 20], ["ACE_20Rnd_762x51_Mag_Tracer", 10], ["CUP_15Rnd_9x19_M9", 10]] + twc_cratemagazines)],
...
twc_loadout_usmcsniper_shooter = [
	...
	[["all"], ([["CUP_10Rnd_127x99_m107", 50], ["CUP_10Rnd_127x99_m107", 20], ["CUP_10Rnd_127x99_m107", 20], ["ACE_20Rnd_762x51_M118LR_Mag", 20], ["ACE_20Rnd_762x51_Mag_Tracer", 10], ["9Rnd_45ACP_Mag", 10]] + twc_cratemagazines)],
	
	//items to remove from crate, items to add
	
	[["all"], ([["ACE_Tripod", 1], ["CUP_optic_AN_PVS_10", 1], [(selectrandom ["CUP_H_FR_Boonie_DES", "H_Booniehat_tan", "CUP_H_PMC_EP_Headset"]), 1], [(selectrandom ["CUP_H_FR_Boonie_DES", "H_Booniehat_tan", "CUP_H_PMC_EP_Headset"]), 1]] + twc_crateitems)],
...
twc_loadout_usmcsniper_spotter = [
	...
	//vestitems
	[["ACRE_PRC152", 1], ["ACE_RangeCard", 1], ["ACE_Kestrel4500", 1], ["ACE_Tripod", 1], ["9Rnd_45ACP_Mag", 4], ["UK3CB_BAF_SmokeShell", 1], ["CUP_20Rnd_762x51_B_M110", 40]],
	...
	//night kit: night uniform, nvg class, night items, night weapons if required (can be blank)
	["CUP_U_I_Ghillie_Top", "CUP_NVG_PVS15_black", [["cup_optic_goshawk_ris", 1], ["ACE_Flashlight_KSF1", 1], ["ACE_Chemlight_IR", 3], ["Chemlight_red", 3]], [["twc_m2010_scope", ["CUP_optic_AN_PVS_10"]]]],

	//weapons
	[[(["twc_m2010_scope"] call bis_fnc_selectrandom), ["CUP_optic_LeupoldMk4_2_d"]], ["hgun_ACPC2_F", ["cup_acc_cz_m3x"]], ["ACE_Vector", []]],
	...
	[["all"], ([["CUP_20Rnd_762x51_B_M110", 50], ["CUP_10Rnd_127x99_m107", 50], ["CUP_10Rnd_127x99_m107", 20], ["CUP_10Rnd_127x99_m107", 20], ["ACE_20Rnd_762x51_M118LR_Mag", 20], ["ACE_20Rnd_762x51_Mag_Tracer", 10], ["9Rnd_45ACP_Mag", 10]] + twc_cratemagazines)],
...
twc_loadout_rangersniper_shooter = [
	...
	//backpack
	"CUP_B_US_Assault_OCP_mc",

	//backpackitems
	[["ACE_20Rnd_762x51_Mk319_Mod_0_Mag", 2], ["ACE_20Rnd_762x51_Mag_Tracer", 5]],

	//night kit: night uniform, nvg class, night items, night weapons if required (can be blank)
	["CUP_U_I_Ghillie_Top", "CUP_NVG_PVS15_black", [["cup_optic_goshawk_ris", 1], ["ACE_MX2A", 1], ["ACE_Flashlight_KSF1", 1], ["ACE_Chemlight_IR", 3], ["Chemlight_red", 3]], [["CUP_srifle_M110", ["CUP_optic_AN_PVS_10", "cup_acc_anpeq_15_flashlight_tan_l", "cup_bipod_harris_1a2_l", "CUP_muzzle_snds_M110"]]]],

	//weapons
	[[(["CUP_srifle_M110"] call bis_fnc_selectrandom), ["CUP_optic_LeupoldMk4_2_d", "cup_acc_anpeq_15_flashlight_tan_l", "cup_bipod_harris_1a2_l", "CUP_muzzle_snds_M110"]], ["CUP_hgun_Glock17", []], ["ACE_Yardage450", []]],
	...
	[["all"], ([["twc_m2010_scope", 1], ["CUP_srifle_M107_LeupoldVX3", 1], ["CUP_hgun_Glock17", 1]] + twc_crateweapons)],
	
	//mags to remove from crate, mags to add
	
	[["all"], ([["CUP_20Rnd_762x51_B_M110", 50], ["CUP_10Rnd_127x99_m107", 50], ["CUP_10Rnd_127x99_m107", 20], ["CUP_10Rnd_127x99_m107", 20], ["ACE_20Rnd_762x51_Mk319_Mod_0_Mag", 20], ["ACE_20Rnd_762x51_Mag_Tracer", 10], ["CUP_17Rnd_9x19_glock17", 10]] + twc_cratemagazines)],
...
twc_loadout_rangersniper_spotter = [
	...
	//vestitems
	[["ACRE_PRC152", 1], ["ACE_ATragMX", 1], ["ACE_Kestrel4500", 1], ["ACE_Tripod", 1], ["CUP_17Rnd_9x19_glock17", 4], ["UK3CB_BAF_SmokeShell", 1], ["CUP_20Rnd_762x51_B_M110", 40]],
	...
	//weapons
	[[(["twc_m2010_scope"] call bis_fnc_selectrandom), ["CUP_optic_LeupoldMk4_2_d"]], ["CUP_hgun_Glock17", []], ["ACE_Vector", []]],
...
twc_loadout_baf_shooter = [
	//uniform
	(["CUP_U_B_BAF_DPM_GHILLIE"] call bis_fnc_selectrandom),
	...
	//vest
	(["V_Rangemaster_belt"] call bis_fnc_selectrandom),
	...
	//backpack
	"TWC_Backpack_Modern_Sniper",

	//backpackitems
	[["UK3CB_BAF_L85A3_RIS_ELCAN3D", 1], ["TWC_5Rnd_338_300gr_HPBT_Mag", 5]],

	//night kit: night uniform, nvg class, night items, night weapons if required (can be blank)
	["CUP_U_B_BAF_DPM_GHILLIE", "CUP_NVG_PVS14", [["cup_optic_an_pas_13c1", 1], ["ACE_Flashlight_KSF1", 1], ["ACE_Chemlight_IR", 3], ["Chemlight_red", 3]], [["twc_l115a3_wd_covered", ["CUP_optic_AN_PVS_10"]]]],
	...
	[["all"], ([["TWC_5Rnd_338_300gr_HPBT_Mag", 50], ["TWC_5Rnd_338_300gr_HPBT_Mag", 10], ["CUP_10Rnd_127x99_m107", 5], ["CUP_10Rnd_127x99_m107", 3], ["CUP_10Rnd_127x99_m107", 2], ["CUP_17Rnd_9x19_glock17", 10]] + twc_cratemagazines)],
...
twc_loadout_baf_spotter = [
	...
	//backpack
	"TWC_Backpack_Modern_Spotter",

	//backpackitems
	[["TWC_5Rnd_338_300gr_HPBT_Mag", 6], ["TWC_5Rnd_338_300gr_HPBT_Mag", 5], ["UK3CB_BAF_762_L42A1_20Rnd", 6], ["UK3CB_BAF_762_L42A1_20Rnd_T", 3]],

	//night kit: night uniform, nvg class, night items, night weapons if required (can be blank)
	["CUP_U_B_BAF_DPM_GHILLIE", "CUP_NVG_PVS14", [["ACE_MX2A", 1], ["ACE_Flashlight_KSF1", 1], ["ACE_Chemlight_IR", 3], ["Chemlight_red", 3]], [["twc_l129a1_spotter", ["UK3CB_BAF_MaxiKite"]]]],
	...
	[["all"], ([["UK3CB_BAF_762_L42A1_20Rnd", 50], ["UK3CB_BAF_762_L42A1_20Rnd_T", 10], ["CUP_10Rnd_127x99_m107", 50], ["CUP_10Rnd_127x99_m107", 20], ["CUP_10Rnd_127x99_m107", 20], ["TWC_5Rnd_338_300gr_HPBT_Mag", 20], ["TWC_5Rnd_338_300gr_HPBT_Mag", 10], ["CUP_17Rnd_9x19_glock17", 10], ["APERSTripMine_Wire_Mag", 2]] + twc_cratemagazines)],
...
twc_loadout_uksfsniper_shooter = [
	...
	//vest
	(["CUP_V_I_RACS_Carrier_Rig_wdl_2"] call bis_fnc_selectrandom),
...
////twc_halfghillie_desert
	...
	[["all"], ([["ACE_10Rnd_338_300gr_HPBT_Mag", 50], ["ACE_10Rnd_338_API526_Mag", 5], ["CUP_10Rnd_127x99_m107", 5], ["CUP_10Rnd_127x99_m107", 3], ["CUP_10Rnd_127x99_m107", 2], ["CUP_17Rnd_9x19_glock17", 10]] + twc_cratemagazines)],
...
twc_loadout_uksfsniper_spotter = [
	...
	[["all"], ([["UK3CB_BAF_762_L42A1_20Rnd", 50], ["UK3CB_BAF_762_L42A1_20Rnd_T", 10], ["ACE_10Rnd_338_300gr_HPBT_Mag", 20], ["ACE_10Rnd_338_API526_Mag", 20], ["CUP_10Rnd_127x99_m107", 50], ["CUP_10Rnd_127x99_m107", 20], ["CUP_10Rnd_127x99_m107", 20], ["CUP_17Rnd_9x19_glock17", 10]] + twc_cratemagazines)],
