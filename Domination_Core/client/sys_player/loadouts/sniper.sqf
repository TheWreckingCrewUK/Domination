...
twc_loadout_baf_shooter = [
	...
	//night kit: night uniform, nvg class, night items, night weapons if required (can be blank)
	["CUP_U_B_BAF_DPM_GHILLIE", "rhsusf_ANPVS_14", [["cup_optic_an_pas_13c1", 1], ["ACE_Flashlight_KSF1", 1], ["ACE_Chemlight_IR", 3], ["Chemlight_red", 3]], [["twc_l115a3_wd_covered", ["rhsusf_acc_premier_anpvs27"]]]],
...
twc_loadout_baf_spotter = [
	...
	//night kit: night uniform, nvg class, night items, night weapons if required (can be blank)
	["CUP_U_B_BAF_DPM_GHILLIE", "rhsusf_ANPVS_14", [["ACE_MX2A", 1], ["ACE_Flashlight_KSF1", 1], ["ACE_Chemlight_IR", 3], ["Chemlight_red", 3]], [["twc_l129a1_spotter", ["UK3CB_BAF_MaxiKite"]]]],
