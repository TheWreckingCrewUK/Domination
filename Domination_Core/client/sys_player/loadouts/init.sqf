...
if((typeOf player) in ["Modern_British_Sniper", "Modern_British_Spotter"])then{
	...
	_snaction1 = ["Spawnsnipbox","What's this?","",{["sniper"] execvm "domination_Core\client\sys_player\loadouts\teaminfo.sqf";},{true}] call ace_interact_menu_fnc_createAction;
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "teamswitch"],_snaction1,true] call ace_interact_menu_fnc_addActionToClass;
};
...
if((typeOf player) in ["Modern_British_FSTCommander"])then{
	...
	_snaction1 = ["Spawnsnipbox","USMC","",{call twc_loadout_fstgroup_us},{((((group player) getvariable ["twc_groupcountry", "baf"])) != "us")}] call ace_interact_menu_fnc_createAction;
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "teamswitch"],_snaction1,true] call ace_interact_menu_fnc_addActionToClass;
	...
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "teamswitch"],_snaction1,true] call ace_interact_menu_fnc_addActionToClass;
	/*
	_snaction1 = ["Spawnsnipbox","Rangers","",{call twc_loadout_fstgroup_ussf},{((((group player) getvariable ["twc_groupcountry", "baf"])) != "ussf")}] call ace_interact_menu_fnc_createAction;
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "teamswitch"],_snaction1,true] call ace_interact_menu_fnc_addActionToClass;
	*/
};
...
if((typeOf player) in ["Modern_UKSF_Squadleader"])then{
	...
	_snaction1 = ["Spawnsnipbox","What's this?","",{execvm "domination_Core\client\sys_player\loadouts\teaminfo.sqf";},{true}] call ace_interact_menu_fnc_createAction;
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "teamswitch"],_snaction1,true] call ace_interact_menu_fnc_addActionToClass;
};
...
twc_loadout_insurgentswitch = {
	...
	if ((player getvariable ["twc_hasenemyeh", 0]) == 0) then {
		...
		twc_fn_getcivcar = ["getcivcar","Spawn Car","",{execvm "domination_core\client\sys_player\vehicles\civcar.sqf"},{(!([getpos player, 2000] call twc_fnc_isnearblufor)) && ((player distance twc_basepos) > 2000)}] call ace_interact_menu_fnc_createAction;
		[player, 1, ["ACE_SelfActions", "enemy_Interact"], twc_fn_getcivcar] call ace_interact_menu_fnc_addActionToObject;
	
		twc_fn_getarmedcar = ["getcivcar","Spawn Technical","",{execvm "domination_core\client\sys_player\vehicles\enemytechnical.sqf"},{(!([getpos player, 8000] call twc_fnc_isnearblufor)) && ((player distance twc_basepos) > 8000)}] call ace_interact_menu_fnc_createAction;
