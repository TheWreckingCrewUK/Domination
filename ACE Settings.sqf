...
force force ace_advanced_fatigue_terrainGradientFactor = 3;
...
force force ace_medical_treatment_cprSuccessChanceMax = 0.2;
...
ace_spectator_maxFollowDistance = 15;
...
force force ace_hitreactions_minDamageToTrigger = 0;
...
force force acre_sys_core_ts3ChannelName = "ACRE - Public";
force force acre_sys_core_ts3ChannelPassword = "dontjoinmebroPublic";
...
force force kat_breathing_cyanosisShowInMenu = false;
...
kat_circulation_bloodgroup = "O_N";
...
force force kat_pharma_pervitinSpeed = 1.2;
...
force force kat_pharma_treatmentTime_EACA = 3.04;
...
force kat_surgery_simpleChance = 5;
